export const dashboardStats = [
  { label: "Total Inquiries", value: "128", trend: "+18 this week" },
  { label: "Active Cities", value: "12", trend: "Roadshow live" },
  { label: "Event Formats", value: "4", trend: "Flagship catalog" },
  { label: "VIP Pass Requests", value: "46", trend: "+9 today" }
];
...
export const inquiries = [
  ...
  },
  {
    id: "INQ-1026",
    name: "Anand Shinde",
    company: "Matrix AI Labs",
    email: "anand@matrixlabs.ai",
    interestArea: "Event Registration",
    status: "Pending Review",
    city: "Pune"
  }
];

export const passRequests = [
  {
    id: "VIP-4301",
    name: "Vikramaditya Sen",
    company: "Infosys Global",
    designation: "Director of Talent Acquisition",
    city: "Indore",
    format: "HR Meet-Up",
    goal: "Benchmark modern AI workflow tools in HR systems",
    status: "Generated"
  },
  {
    id: "VIP-4302",
    name: "Meera Kapoor",
    company: "Nexora People Cloud",
    designation: "CHRO",
    city: "Bengaluru",
    format: "CHRO Leadership Summit",
    goal: "Meet enterprise SaaS and transformation leaders",
    status: "Pending"
  }
];
